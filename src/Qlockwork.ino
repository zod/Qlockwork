...
void debugScreenBuffer(uint16_t screenBuffer[])
{
	...
	{
	  { 'E', 'S', 'M', 'I', 'S', 'C', 'H', 'F', 'U', 'H', 'R', '1' },
	  { 'D', 'R', 'E', 'I', 'V', 'I', 'E', 'R', 'T', 'L', 'A', '2' },
	  { 'Z', 'E', 'H', 'N', 'M', 'U', 'E', 'F', 'U', 'N', 'F', '3' },
	  { 'N', 'A', 'C', 'H', 'L', 'L', 'E', 'R', 'V', 'O', 'R', '4' },
	  { 'H', 'A', 'L', 'B', 'N', 'F', 'U', 'N', 'F', 'E', 'U', 'A' },
	  { 'O', 'I', 'S', 'E', 'C', 'H', 'S', 'E', 'L', 'F', 'E', ' ' },
	  { 'Z', 'W', 'O', 'I', 'E', 'A', 'C', 'H', 'T', 'E', 'X', ' ' },
	  { 'D', 'R', 'E', 'I', 'E', 'Z', 'W', 'O', 'L', 'F', 'E', ' ' },
	  { 'Z', 'E', 'H', 'N', 'E', 'U', 'N', 'E', 'A', 'N', 'I', ' ' },
